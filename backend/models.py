...
class Retailer(db.Model):
    ...
    # Relationships
    pricing_tier = db.relationship('PricingTier', backref='retailers')
...
class Shipment(db.Model):
    ...
    shipment_status = db.Column(db.String(50), nullable=False, default='Pending')
...
class QualityCheck(db.Model):
    ...
    # Relationships
    batch = db.relationship('Batch', backref='quality_checks')
    checker = db.relationship('User', backref='quality_checks')
